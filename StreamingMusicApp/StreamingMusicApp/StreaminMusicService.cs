...
namespace StreamingMusicApp
{
    public class StreamingMusicService
    {
        ...
        public void AddSong(string artist, string title, Genre genre, int durationInSeconds)
        {
            this.songs.Add(new Song(this.songIdSeeder, artist, title, genre, durationInSeconds));
            this.songIdSeeder++;
        }
